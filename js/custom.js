...
function typer() {
    var win = $(window),
        foo = $('#typer');
    foo.typer(['<h2><span class="text-color-1">Full stack</span> Developer</h2>','<h2><span class="text-color-1">Web</span> Developer</h2>', '<h2>Cloud <span class="text-color-1">Developer</span></h2>', '<h2><span class="text-color-1">Frontend</span> Developer</h2>', '<h2><span class="text-color-1">Team</span> Lead</h2>', '<h2><span class="text-color-1">Technical</span> Architect</h2>']);
}
